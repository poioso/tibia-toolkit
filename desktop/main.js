...
async function createOverlayWindow() {
  ...
  window.on("ready-to-show", () => {
    ...
    // Electron's roundedCorners option does not affect borderless Windows windows.
    // Apply the native DWM preference after the installed window is visible.
...
async function applyNativeWindowCornerPreference(window) {
  ...
  try {
    ...
    // This cosmetic Windows preference must never block startup.
