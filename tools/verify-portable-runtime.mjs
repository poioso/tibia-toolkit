...
const requiredFiles = [
  ...
  "resources/app/desktop/supporters-showcase.html",
  "resources/app/desktop/supporters-showcase-preload.cjs",
  "resources/app/desktop/window-move-handle.html",
  "resources/app/desktop/window-move-handle-preload.cjs",
...
const forbiddenNames = [
  ...
  /(^|[/\\])ACESSOS_PRIVADOS_EMAIL_TIBIA_TOOLKIT\.md$/i,
  /(^|[/\\])ACESSOS_PRIVADOS_SITE\.md$/i,
  /(^|[/\\])ACESSOS_PRIVADOS_SITE_HOSPEDAINFO\.md$/i,
  /(^|[/\\])\.env(?:\..+)?$/i,
  /\.corrupted-[^/\\]+$/i,
